function TABS() {
    ...
    let num = prompt('Numero a multiplicar');
    let limit = prompt('Limite');
    document.write('Tabla de multiplicar del ' + num + '<br>')
    for (let z = 1; z <= limit; z++) {
        let result = z * parseInt(num)
        document.write(z + ' x ' + num + ' = ' + result + '<br>' + '<body style="background: black; color: white;">')
